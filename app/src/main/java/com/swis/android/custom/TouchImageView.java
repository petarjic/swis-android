package com.nitesh.nisininvoice.custom;
...
public class TouchImageView extends AppCompatImageView implements View.OnTouchListener {
    ...
    public void setBitmap(Bitmap bitmap, Point size) {
        if (bitmap != null) {
            setImageBitmap(bitmap);

            mBitmapWidth = bitmap.getWidth();
            mBitmapHeight = bitmap.getHeight();
            mBitmapMiddlePoint.x = (size.x / 2) - (mBitmapWidth / 2);
            mBitmapMiddlePoint.y = (size.y / 2) - (mBitmapHeight / 2);
