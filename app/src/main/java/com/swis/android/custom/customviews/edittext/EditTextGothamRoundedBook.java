...
public class EditTextGothamRoundedBook extends androidx.appcompat.widget.AppCompatEditText {

    private static Typeface typeface;

    public EditTextGothamRoundedBook(Context context) {
        super(context);
        applyCustomFont(context);

    }

    public EditTextGothamRoundedBook(Context context, AttributeSet attrs) {
        super(context, attrs);
        applyCustomFont(context);

    }

    public EditTextGothamRoundedBook(Context context, AttributeSet attrs, int defStyle) {
